...
// weeklyTimes is fetched by the caller so it can run alongside the other
// Diyanet calls instead of being serialised behind them.
export async function generateIqamaChangeNotices(prayerTimes, weeklyTimes) {
    let notices = [];
